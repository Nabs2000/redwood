...
export function Button({
  ...
  const variants = {
    ...
    outline: 'border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 focus:ring-emerald-500 dark:border-emerald-500 dark:text-emerald-500 dark:hover:bg-emerald-950',
