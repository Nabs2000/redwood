...
import { type WeeklyAvailability, type ServiceType } from '~/types/mentor.types';
...
export default function MentorProfileSetup() {
  ...
  // Services offered
  const [services, setServices] = useState<ServiceType[]>(['initial-consultation']);
        ...
        <Card>
          ...
          <CardContent>
            ...
            {step === 2 && (
              <div className="space-y-4">
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                  Select the days and times you're typically available for mentoring sessions. You
            ...
            {step === 3 && (
              <div className="space-y-4">
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                  Select the types of services you'd like to offer to mentees. Initial consultation
                  is required.
                </p>
                      ...
                      <div>
                        <div className="font-medium text-slate-900 dark:text-slate-100">
                          ...
                          {service.value === 'initial-consultation' && (
                            <span className="ml-2 text-xs text-emerald-600">(Required)</span>
                          )}
                        </div>
      ...
      <div className="border-2 border-slate-200 dark:border-slate-700 rounded-lg p-4">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-medium text-slate-900 dark:text-slate-100">
            {selectedDay.charAt(0).toUpperCase() + selectedDay.slice(1)} Availability
          </h4>
            ...
            {availability[selectedDay].map((slot, index) => (
              <div key={index} className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    updateTimeSlot(selectedDay, index, 'startTime', e.target.value)
                  }
                />
